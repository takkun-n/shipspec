...
async function generateWord(d) {
  ...
  children.push(
    ...
    emptyP(),
    h2('8-8　一般照明電灯'),
    para('各室・通路・甲板等に一般照明電灯を装備する。'),
    para('機関室の照明器具の防爆型の適否については、爆発性雰囲気の度合いに応じ定める。'),
    emptyP(),
    h2('8-9　プラグ及びレセプタクル'),
    para('プラグのソケット形は３口とし、丸形は２口とする。'),
    para('ＤＣ２４Ｖレセプタクルは設置しない。（船内通信用として４ヵ所以上付）'),
    emptyP(),
    para('一般照明電灯装備一覧表'),
    para('設記：Ｎ＝丸形　Ｓ＝角形　Ｔ＝防工形　Ｕ＝防雨形'),
    new Table({width:{size:CW,type:WidthType.DXA}, columnWidths:[2700,700,700,700,700,700,700,700,700,700,746], rows:[
      ...
      ...formRowsToTableRows(d.lightingRows, [2700,700,700,700,700,700,700,700,700,700,746]),
    ]}),
    pb(),
  );
