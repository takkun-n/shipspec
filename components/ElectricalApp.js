...
// 5章: 動力装置 - 電動機要目表（機関部）
const initMotorRows = [
  {type:'normal',cells:['主空気圧縮機','2','440','5.5','4','連続','全閉外扇','全電圧','']},
  {type:'normal',cells:['消防兼ビルジポンプ','2','440','22','4','連続','全閉外扇','スターデルタ','LSW,RSW']},
  {type:'normal',cells:['冷却海水ポンプ','1','440','','4','連続','全閉外扇','全電圧','LSW,LVR']},
  {type:'normal',cells:['予備清浄油清水ポンプ','1','440','11','4','連続','全閉外扇','','LSW']},
  {type:'normal',cells:['造水分離器附ポンプ','2','440','0.75','4','連続','全閉外扇','','']},
  {type:'normal',cells:['A重油移送ポンプ','2','440','0.75','4','連続','全閉外扇','','AST,ES2,LSW']},
  {type:'normal',cells:['燃料清浄機ポンプ','1','440','0.4','6','連続','全閉外扇','全電圧','LSW,LVR,ES2']},
  {type:'normal',cells:['低速清浄機移送送液ポンプ','1','440','0.4','6','連続','全閉外扇','','LSW,LVR,ES2']},
  {type:'normal',cells:['逆転機予備清浄機ポンプ','1','440','15','6','連続','全閉外扇','','LSW,LVR,ES2']},
  {type:'normal',cells:['低速清浄機補給液ポンプ','1','440','0.4','6','連続','全閉外扇','','ES2']},
  {type:'normal',cells:['ヒーター','1','440','10','','連続','全閉外扇','','ES2']},
  {type:'normal',cells:['高速清浄機移送液ポンプ','1','440','0.4','6','連続','全閉外扇','','ES2']},
  {type:'normal',cells:['低温冷却清水ポンプ','2','440','','','連続','','全電圧','']},
  {type:'normal',cells:['高温冷却清水ポンプ','2','440','','','連続','','全電圧','']},
  {type:'normal',cells:['清水ホームポンプ','1','200','0.4','2','連続','防滴保護','','AST']},
  {type:'normal',cells:['ターニングモーター','1','440','0.4','','','全閉外扇','全電圧','RSW']},
  {type:'normal',cells:['電動式チェンブロック','1','440','0.8','4','30分','','','RSW']},
  {type:'normal',cells:['補助室通風機','2','440','3.7','4','連続','軸流','','ES2']},
];

const initDeckMotorRows = [
  {type:'normal',cells:['錨揚機','1','440','37','','連続','全閉外扇','スターデルタ','RSW']},
  {type:'normal',cells:['舵取機','1','440','30','','連続','全閉外扇','スターデルタ','RSW']},
  {type:'normal',cells:['操舵機','2','440','5.5','4','連続','全閉外扇','全電圧','LVR']},
  {type:'normal',cells:['家庭用空調設備（室内機）','4','200','1.9','4','連続','全閉外扇','','']},
  ...
  {type:'normal',cells:['','1','220','5.5','','連続','全閉外扇','全電圧','PT(変圧器)']},
  {type:'normal',cells:['','1','440','0.4','4','連続','全閉外扇','全電圧','ES2']},
  {type:'normal',cells:['バラストポンプ','1','440','22','4','連続','全閉外扇','スターデルタ','']},
  {type:'normal',cells:['','1','440','3','','','','','ES2']},
  {type:'normal',cells:['清水膨張タンクヒーター','1','440','3','','連続','','','ES2']},
];
...
// 8章: 一般照明電灯装備一覧表（8-9.pdf より読み取り）
// 列: 場所, シーリング(AC●防/○非), 外部通路灯, 浴室灯, 階段灯, 機器灯, 補助灯, 持ち灯, 防灯, 非常灯(DC24V), 設記
// 設記凡例: ●防水形 ○非防水形 ☆防爆型 ◎防滴型
const initLightingRows = [
  // ── 上部区画（操舵室・居住区周辺）──
  {type:'normal',cells:['操舵室','●','','','','','','','','●','']},
  {type:'normal',cells:['海図上・外部','','','','','','','','●','','']},
  {type:'normal',cells:['廻廊甲板','','','','','','','','','','']},
  {type:'normal',cells:['蓄電池室','','','','','','','','','','']},
  {type:'normal',cells:['食堂（８席）','○','','○','○','','','','','●','']},
  {type:'normal',cells:['内部通路','○','','','','','','','','','']},
  {type:'normal',cells:['外部通路','','','','','','','','●','','']},
  {type:'normal',cells:['機関室','●','','','','','','','','●','']},
  {type:'normal',cells:['食堂','●','','','','','','','','','']},
  {type:'normal',cells:['シャワー室','●','','','','','','','','','']},
  // ── 下部区画（甲板・機関区域）──
  {type:'normal',cells:['内部通路','','','','','','','○','','','']},
  {type:'normal',cells:['外部通路','','','','','','','','','','']},
  {type:'normal',cells:['電室','●','','','','','','','','','']},
  {type:'normal',cells:['食事室','●','','','','','','','','','']},
  {type:'normal',cells:['洗面所','','','','','','','','','','◎']},
  {type:'normal',cells:['前部監視室','●','','','','','','','','','']},
  {type:'normal',cells:['機関室前','●','','','','','','','','●','']},
  {type:'normal',cells:['機関室後','','','','','','','','','','']},
  {type:'normal',cells:['甲板倉庫','☆','','','','','','','','','']},
  {type:'normal',cells:['ポンプ室','☆','','','','','','','','','']},
  // ── 追加・予備 ──
  {type:'normal',cells:['','','','','','','','','','','']},
  {type:'normal',cells:['','','','','','','','','','','']},
  {type:'normal',cells:['','','','','','','','','','','']},
